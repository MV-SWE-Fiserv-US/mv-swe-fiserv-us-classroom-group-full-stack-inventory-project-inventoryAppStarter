          ...
          >
            ...
            <div className="px-5 pb-5 bg-white mt-auto rounded-b-lg h-1/2 flex flex-col justify-end w-full">
              ...
              <div className="flex items-center justify-between mt-2.5 mb-5 bg-white">
                ...
                <span className="font-mono bg-white text-blue-800 text-xs font-semibold px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800 ms-3">
                  {num}.0
                </span>
              </div>
              <div className="flex items-center justify-between bg-white font-mono mt-2 w-full">
                ...
                <a
                  href="#"
                  className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 font-mono"
                >
                  Add to cart
                </a>
              </div>
