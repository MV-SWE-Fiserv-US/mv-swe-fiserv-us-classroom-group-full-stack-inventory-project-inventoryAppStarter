...
export default function ItemCard({ items, setSingleItem }) {
    ...
    return (
        <div className="item-container">
            {items.map((item) => {
                const num = Math.floor(Math.random() * 6); // Random number between 0 and 5
                return (
                    <div className="item-card" key={item.id} onClick={() => handleClick(item)}>
                        ...
                        <div className="px-5 pb-5">
                            ...
                            <div className="flex items-center mt-2.5 mb-5">
                                ...
                                <span className="bg-blue-100 text-blue-800 text-xs font-semibold px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800 ms-3">{num}.0</span>
                            </div>
