...
export default function Footer() {
    ...
    return (
        <footer className="bg-gray-800 text-white py-4">
            ...
            <p className="text-sm" onClick={() => setClick(!click)}> &copy; {new Date().getFullYear()} {!click ? "Vaultry. All rights reserved." : "Vaultry. All rights reserved. (JK don't sue us, this is for a school project)"}</p>
                <div className="mt-2">
